        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <ul class="menu-content">
                    ...
                    <li class="active nav-item"><a href="/admineditpatient"><i class="feather icon-edit"></i><span
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <a class="btn btn-primary mr-2 mb-2 waves-effect waves-light " id="operate" style="display: none" href="/admineditpatient" role="button" >Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="account-vertical-basicInfo{{$user->id}}"
                                                ...
                                                <form method="POST"
                                                    action="/adminupdatepatient1/{{$user->id}}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                            ...
                                            <div class="tab-pane fade " id="account-vertical-contact{{$user->id}}" role="tabpanel"
                                                ...
                                                <form method="POST"
                                                    action="/adminupdatepatient2/{{$user->id}}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label>Address</label>
                                                                    <input type="textbox" class="form-control" name="address" id="address"   >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                            ...
                                            <div class="tab-pane fade " id="account-vertical-employer{{$user->id}}" role="tabpanel"
                                                ...
                                                <form method="POST"
                                                    action="/adminupdatepatient3/{{$user->id}}" enctype="multipart/form-data">
                                                    @csrf
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label>Postal Code</label>
                                                                <input type="text" class="form-control" name="employerPostalCode" id="employerPostalCode"   >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade " id="account-vertical-stats{{$user->id}}" role="tabpanel"
                                                ...
                                                <form method="POST"
                                                    action="/adminupdatepatient4/{{$user->id}}" enctype="multipart/form-data">
                                                    @csrf
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="familySize" id="familySize"   >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="migrantOrSeasonal" id="migrantOrSeasonal"   >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade " id="account-vertical-gaurdian{{$user->id}}" role="tabpanel"
                                                ...
                                                <form method="POST"
                                                    action="/adminupdatepatient5/{{$user->id}}" enctype="multipart/form-data">
                                                    @csrf
                                                <div class="row">
                                                    <div class="col-12 sm-3">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label>Address</label>
                                                                <input type="text" class="form-control" name="gaurdianAddress" id="gaurdianAddress"   >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label>City</label>
                                                                <input type="text" class="form-control" name="guardianCity" id="guardianCity"   >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label>Postal Code</label>
                                                                <input type="text" class="form-control" name="guardianPostalCode" id="guardianPostalCode"   >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
