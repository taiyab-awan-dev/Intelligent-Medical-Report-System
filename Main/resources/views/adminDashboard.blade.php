                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="users-view-image">
                                            @if (Auth::user()->image != 'user.png')
                                            <img src="{{ asset('/storage/image/'  . Auth::user()->image) }}" class="users-avatar-shadow w-100 rounded mb-2 pr-2 ml-1" alt="avatar">
                                            @else
                                        ...
                                        <div class="col-12">
                                            <a href="/adminOwnEdit" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
