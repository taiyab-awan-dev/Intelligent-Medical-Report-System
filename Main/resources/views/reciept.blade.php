...
<html>
	<head>
		<meta charset="utf-8">
		<title>Reciept for the Appointment</title>
...
@page { margin: 0; }
	...
	<body>
		<header>
			<h1>Reciept of Appointment</h1>
			<address contenteditable>
				<p></p>
				<p>{{$invoice->patientaddress}}</p>
				<p>{{$invoice->patientcontact}}</p>
			</address>
		...
		<article>
			...
			<table class="meta">
				<tr>
					<th><span contenteditable>Reciept #</span></th>
					<td><span contenteditable>{{$invoice->id}}</span></td>
				</tr>
				<tr>
					<th><span contenteditable>Date</span></th>
					<td><span contenteditable>{{$invoice->updated_at}}</span></td>
				</tr>
				<tr>
					<th><span contenteditable>Amount Due</span></th>
					<td><span id="prefix" contenteditable>Rs.</span><span>0</span></td>
				</tr>
				<tr>
					<th><span contenteditable>Generated By</span></th>
					<td><span id="prefix" contenteditable></span><span>{{$invoice->generatedBy}}</span></td>
				</tr>
			</table>
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span contenteditable>{{$invoice->doctorname}}</span></td>
						<td><span data-prefix></span><span contenteditable>{{$invoice->doctoremail}}</span></td>
						<td><span contenteditable>{{$invoice->time}}</span></td>
						<td><span data-prefix></span><span>{{$invoice->date}}</span></td>
					</tr>
				</tbody>
			</table>
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>Rs.</span><span>{{$invoice->amount}}</span></td>
				</tr>
				<tr>
					<th><span contenteditable>Amount Paid</span></th>
					<td><span data-prefix>Rs.</span><span contenteditable>{{$invoice->amount}}</span></td>
				</tr>
				<tr>
