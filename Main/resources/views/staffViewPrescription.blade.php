                            ...
                            <li class="dropdown dropdown-user nav-item">
                                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                    <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">
                                        ...
                                        <img class="round" src="{{ asset('/storage/image/' . Auth::user()->email . Auth::user()->image) }}" alt="avatar" height="40" width="40">
                                        @else
                                        <img class="round" src="/storage/image/user.png" alt="avatar" height="40" width="40">
                                        @endif
                                    </span>
                                </a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a href="/staffViewPrescription"><i class="feather icon-edit"></i><span class="menu-title" data-i18n="View Prescription">View Prescription</span></a>
                </li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a>View Prescription</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <section id="data-list-view" class="data-list-view-header">
                        ...
                        <div class="table-responsive ml-2">
                            <table class="table data-list-view">
                                ...
                                <tbody>
                                    @foreach ($appointments as $prescription)
                                    <tr>
                                        <td hidden></td>


                                        <td class="product-name">{{ $prescription->id }}</td>

                                        <td class="product-name">{{ $prescription->patient->name }}</td>
                                        <td class="product-time">{{ $prescription->date }} {{ $prescription->time }}</td>

                                        <td class="product-action">

                                            <a onclick="document.getElementById('form2{{ $prescription->id }}').submit()" id="del{{ $prescription->id }}" type="button" class="btn btn-icon btn-flat-success nav-link  waves-effect waves-light"><i class="feather icon-eye"></i></a>


                                            <form id="form2{{ $prescription->id }}" target="_blank" action="/showPrescription/{{$prescription->id}}" method="POST" style="display: none;">
                                                @csrf
                                            </form>
                                        </td>
