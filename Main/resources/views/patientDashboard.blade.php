            ...
            <div class="content-body">
                ...
                <section class="page-users-view">
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <a href="/patientOwnEdit" class="btn btn-primary mr-1 waves-effect waves-light"><i class="feather icon-edit-1"></i> Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- account end -->
                        @if($flag == 1)
                            <div class="toast show ml-1" role="alert" aria-live="assertive" aria-atomic="true" data-delay="5000">
                                <div class="toast-header">
                                <img src="../../../app-assets/images/logo/logo.png" class="rounded mr-2" alt="Toast Image">
                                <strong class="ml-2 align-center mr-auto">Reminder  </strong>
