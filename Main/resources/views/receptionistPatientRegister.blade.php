   ...
   <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <li class=" nav-item"><a href="/receptionistDashboard"><i class="feather icon-home"></i><span class="menu-title" data-i18n="dashboard">Dashboard</span></a>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="active nav-item"><a href="/receptionistpatientRegister"><i class="feather icon-user"></i><span class="menu-title" data-i18n="RegisterPatient">Register Patient</span></a>
            </li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a>Patients</a>
                                    </li>
