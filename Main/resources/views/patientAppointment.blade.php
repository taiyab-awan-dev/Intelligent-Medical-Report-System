...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click"
                        ...
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li class="dropdown dropdown-user nav-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                        href="/patientOwnEdit"><i class="feather icon-user"></i> Edit Profile</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="/patientViewPrescription"><i class="feather icon-edit"></i><span
                            class="menu-title" data-i18n="View Prescriptions">View Prescriptions</span></a>
                </li>
                <li class=" nav-item"><a href="/patientTestRecommendation"><i class="feather icon-user"></i><span
                            class="menu-title" data-i18n="Test Recommendation">Test Recommendation</span></a>
                </li>
                <li class="active nav-item"><a href="/patientAppointment"><i class="feather icon-edit"></i><span
                            class="menu-title" data-i18n="Appointment">Appointment</span></a>
                </li>
            </ul>
        </div>
    </div>
                                ...
                                @foreach ($appointments as $appointment)
                                    <tr>
                                        ...
                                        <td class="product-action">
                                            @if($appointment->status!=3 && $appointment->status!=4 && $appointment->status!=2)
                                            <a data-toggle="modal" data-target="#inlineForm{{ $appointment->id }}"
                                                id="edit{{ $appointment->id }}" type="button" onclick="updateTimeChange(this,{{$appointment->id}})"
                                                class="btn btn-icon btn-flat-warning nav-link  waves-effect waves-light"><i
                                                    class="feather icon-edit"></i></a>
                                            @endif
                                            @if($appointment->status!=3 && $appointment->status!=4 )
                                           
                                            <a href="/deleteAppointment/{{$appointment->id}}"
                                    ...
                                    <div class="modal fade text-left" id="inlineForm{{ $appointment->id }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 data-field-col">
                                                                        ...
                                                                        <select  class="select2-theme form-control"
                                                                            name="doctor_id" onchange="updateTimeChange(this,{{$appointment->id}})"
                                                                            id="selectD{{ $appointment->id }}"
                                                                    ...
                                                                    <div class="col-sm-12 data-field-col">
                                                                        <label
                                                                            for="date{{ $appointment->id }}">Date</label>
                                                                        <input id="date{{ $appointment->id }}"
                                                                            name="date" min="{{ date('m-d-Y') }}"
                                                                            value="{{ $appointment->date }}" type='date'
                                                                            class="form-control" />
                                                                    </div>
                                                                    <div class="col-sm-12 data-field-col">
                                                                        <label
                                                                            for="time{{ $appointment->id }}">Time</label>
                    ...
                    <div class="add-new-data-sidebar">
                        ...
                        <div class="add-new-data">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                <div>
                                    <h4 id="11" class="text-uppercase">Add Appointment</h4>
                                </div>
                                <div class="hide-data-sidebar">
                                    <i class="feather icon-x"></i>
                                </div>
                            </div>
                            <form method="POST" action="/addpatAppointment" enctype="multipart/form-data">
                                @csrf
                                <div class="data-items pb-3">
                                    <div class="data-fields px-2 mt-3">
                                        <div class="row">
                                            <div class="col-sm-12 data-field-col">
                                                <label for="doctor_id">Doctor</label>
                                                <select  class="select2-theme form-control" onchange="updateTime(this)" name="doctor_id" id="selectD"
                                                    data-select2-id="select2-theme" tabindex="-1" aria-hidden="true">

                                                    <option selected>Select Doctor</option>
                                                    @foreach ($doctors as $doctor)
                                                        <option value="{{ $doctor->staff_id }}">
                                                            {{ $doctor->doctor->email }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-sm-12 data-field-col">
                                                ...
                                                <input id="date" name="date" min="{{ date('m-d-Y') }}" type='date'
                                                    class="form-control" />
                                            </div>
                                            <div class="col-sm-12 data-field-col">
    ...
    <script type="text/javascript">
        ...
        function updateTime(doc,value)
        {
            ...
            for(var i=0;i<doctors.length;i++)
            {   
                if(document.getElementById('selectD').value == doctors[i].staff_id)
                {
                    var datefrom = new Date('01 01 2021 ' +doctors[i].timefrom);
                    var dateto = new Date('01 01 2021 ' +doctors[i].timeto);
                    while(dateto>=datefrom)
