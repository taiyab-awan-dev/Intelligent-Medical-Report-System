                            ...
                            <tbody>
                                @foreach ($prescriptions as $prescription)
                                    <tr>
                                        ...
                                        <td class="product-name">{{ $prescription->patient->id }}</td>
                                        <td class="product-name">{{ $prescription->doctor->name }}</td>
                                        <td class="product-contact">{{ $prescription->med_name }}</td>
                                        <td class="product-name">{{ $prescription->med_description }}</td>
                                        <td class="product-name">{{ $prescription->med_type }}</td>
                                        <td class="product-name">{{ $prescription->med_dose }}</td>
