    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item sidebar-group-active open"><a href="#"><i class="feather icon-pie-edit"></i><span class="menu-title" >User Management</span></a>
                <ul class="menu-content">
                    ...
                    <li class="active nav-item"><a href="/addStaffRegister"><i class="feather icon-user"></i><span
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                @endif
                <div class="card ml-4 col-11 mr-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form action="/registerstaff" class="form-horizontal" role="form"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-4 ml-4 mr-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="date" class="form-control" name="joined_date"
                                                            ...
                                                            data-validation-required-message="This Joined Date field is required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="date" class="form-control" name="dob" id="dob"
                                                            required
                                                            data-validation-required-message="This DOB field is required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="specialization"
                                                            id="specialization" placeholder="e.g. Dentist" required
                                                            data-validation-required-message="This qualifications field is required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
                                            ...
                                            <div class="col-12 col-sm-4 ml-4 mr-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="qualifications"
                                                            id="qualifications" placeholder="e.g. BA" required
                                                            data-validation-required-message="This qualifications field is required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="textbox" class="form-control" name="address"
                                                            id="address" placeholder="e.g. p111..." required
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="contact"
                                                            id="contact" placeholder="+923/00923xxxxxxx"
                                                            pattern="^((\+92)|(0092))-{0,1}\d{3}-{0,1}\d{7}$|^\d{11}$|^\d{4}-\d{7}$"
                                                            required
                                                            data-validation-required-message="This contact field is required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <select onchange="reloadform(this)"
                                                            class="browser-default custom-select" name="staffType"
                                                            id="staffType">
                                                            <option selected="">Medical Staff</option>
                                                            <option value="2">ParaMedical Staff</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div id="pm" class="form-group">
                                                    <div class="controls">
                                                        <label>PMDC No</label>
                                                        <input type="textbox" class="form-control" value="0"
                                                            name="pmdcNo" id="pmdcNo" placeholder="e.g. 00000000"
                                                            required
                                                            data-validation-required-message="This pmdcNo field is required">
                                                    </div>
                                                </div>
                                                <div id="cm" style="display: none" class="form-group">
                                                    <div class="controls">
                                                        <label>Technology</label>
                                                        <input type="textbox" class="form-control" value="None"
                                                            name="technology" id="technology" placeholder="e.g. CT Scan"
                                                            required
                                                            data-validation-required-message="This Technology field is required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
