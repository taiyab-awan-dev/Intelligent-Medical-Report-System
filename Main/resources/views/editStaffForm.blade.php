    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <ul class="menu-content">
                ...
                <li class="active nav-item"><a href="/admineditStaff"><i class="feather icon-edit"></i><span
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> Manage Staff Details
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <a class="btn btn-primary mr-2 mb-2 waves-effect waves-light " id="operate" style="display: none" href="/admineditStaff" role="button" >Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="account-vertical-general{{$user->id}}"
                                                ...
                                                <form method="POST"
                                                    action="/updateStaff/{{$user->id}}" enctype="multipart/form-data">
                                                    @csrf
                                                            ...
                                                            <div class="col-12 ml-4 col-sm-3">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        ...
                                                                        <input type="text" class="form-control" name="qualifications" id="qualifications" value="{{$staff->qualifications}}"  required data-validation-required-message="This contact field is required">    
                                                                        @endif
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        ...
                                                                        @foreach ($staffs as $staff)
                                                                        @if($staff->staff_id==$user->id)
                                                                        <input type="text" class="form-control" name="specialization" id="specialization" value="{{$staff->specialization}}"  required data-validation-required-message="This contact field is required">    
                                                                        @endif
                                                                        @endforeach
                                                                    </div>
                                                                </div>
