        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <ul class="menu-content">
                    ...
                    <li class="active nav-item"><a href="/admineditAccountant"><i class="feather icon-edit"></i><span
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> Manage Accountant Details
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Select Accountant to edit</h4>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-12">
                                    <div class="form-group">
                                        <select onfocus="hideform(this)" onchange="reloadform(this)"
                                            class="select2-theme form-control" name="id" id="selectP"
                                            data-select2-id="select2-theme" tabindex="-1" aria-hidden="true">
                                            <optgroup label="Accountants">
                                                <option selected>Select Email of the accountant</option>
                                ...
                                <a class="btn btn-primary mr-2 mb-2 waves-effect waves-light " id="operate"
                                    style="display: none" href="/admineditAccountant" role="button">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex py-75 active" id="account-pill-general"
                                            data-toggle="pill" href="#account-vertical-general{{ $user->id }}"
                                            aria-expanded="true">
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active"
                                                    id="account-vertical-general{{ $user->id }}"
                                                    aria-labelledby="account-pill-general" aria-expanded="true">

                                                    <form method="POST" action="/updateAccountant/{{ $user->id }}"
                                                        enctype="multipart/form-data">
                                                        @csrf

                                                        <div class="row">
                                                            <div class="col-4 mr-4 ml-4 md-4">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        ...
                                                                        @foreach ($accountants as $accountant)
                                                                            @if ($accountant->accountant_id == $user->id)
                                                                                <input type="text" class="form-control"
                                                                                    name="qualifications" id="qualifications"
                                                                                    value="{{ $accountant->qualifications }}"
                                                                                    required
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        ...
                                                                        <input type="date" class="form-control"
                                                                            value="{{ $user->dob }}" name="dob" id="dob"
                                                                            required
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        ...
                                                                        <input type="text" class="form-control" name="contact"
                                                                            id="contact" value="{{ $user->contact }}"
                                                                            placeholder="+923/00923xxxxxxx"
                                                        ...
                                                        <div
                                                            class="col-10 d-flex flex-sm-row flex-column justify-content-end">
                                                            <button type="submit"
                                                ...
                                                <div class="tab-pane fade "
                                                    id="account-vertical-password{{ $user->id }}" role="tabpanel"
